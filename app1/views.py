...
def addcourse(request):
    if request.method=="POST":
        ...
        # ---------------------------------------------
        obj=models.course(rnm=rnm,duration=duration,fees=fees,courseicon=courseicon)
        obj.save()
...
def addbatch(request):
    if request.method=="POST":
        ...
        obj=models.batch(rnm=rnm,startdate=startdate,batchtime=batchtime,facultyname=facultyname)
        obj.save()
